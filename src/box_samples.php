<?php
exit; // we do not want to use this script as it is since it does not choose a box (we simply want to copy out the validation parts)
/**
 * @abstract Sample box log for biological samples. This script is to be used with the box_samples.tpl.php script. Ideally we would be able to
...
class BoxSampleEntry8 extends BoxEditFormBase {
	...
	protected function SetupBox() {
		...
		// here we will not load the box for sample editing without the sample box configuration correctly setup
		
		// -------------- CONFIGURATION SETTINGS -----------------------
		$this->strBoxDescriptionConfig = "unique box description for the timepoint";
		$this->strBoxPrefix = "strE03ParseBarcodeTimepoint";	//.'-';	 // removed dash after surpassing the 100 box mark
		$this->intStudyTypeId = 2;
		$this->parseBarcodeTimepoint = "strE03ParseBarcodeTimepoint";	// barcode timepoint string
		$this->PreparedById = __LOGGED_USER_ID__;	// user who is processing the images
		$this->scriptName = "box-view.php";	// name of this script
		$this->scriptListName = "boxes.php";	// name of the main list script
