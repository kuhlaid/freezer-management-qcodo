<?php
	 ...
	 * must create a new Form which extends this SampleboxesEditFormBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class SampleboxesEditFormBase extends QForm {
		...
		protected $txtId;
		protected $txtIncounty;
		protected $calIncountydate;
		protected $txtCountyuser;
		protected $txtChapelhilluser;
		protected $txtIntransit;
		protected $calIntransitdate;
		protected $txtTrackingnum;
		protected $txtReadytoship;
		protected $calReadytoshipdate;
		protected $txtInchapelhill;
		protected $txtIncdc;
		protected $calIncdcdate;
		protected $txtCdcuser;
		protected $calInchapelhilldate;
		...
		protected function SetupSampleboxes() {
			// Lookup Object PK information from Query String (if applicable)
			// Set mode to Edit or New depending on what's found
			$intId = QApplication::QueryString('intId');
			if (($intId)) {
				$this->objSampleboxes = Sampleboxes::Load(($intId));

				if (!$this->objSampleboxes)
					throw new Exception('Could not find a Sampleboxes object with PK arguments: ' . $intId);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect('sampleboxes_list.php');
		}
	}
?>