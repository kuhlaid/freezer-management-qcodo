 ...
 * must create a new Panel which extends this ClinicShipmentEditPanelBase
 * class.
 *
 ...
 *
 */
abstract class ClinicShipmentEditPanelBase extends QPanel {
	...
	public $lblId;
	public $calShipTime;
	public $txtPreparedBy;
	public $txtTrackingNumber;
	...
	protected function SetupClinicShipment($objClinicShipment) {
		if ($objClinicShipment) {
			$this->objClinicShipment = $objClinicShipment;
	...
	public function __construct($objParentObject, $strClosePanelMethod, $objClinicShipment = null, $strControlId = null) {
		// Call the Parent
		try {
		...
		$this->SetupClinicShipment($objClinicShipment);
