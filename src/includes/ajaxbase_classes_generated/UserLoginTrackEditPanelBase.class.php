 ...
 * must create a new Panel which extends this UserLoginTrackEditPanelBase
 * class.
 *
 ...
 *
 */
abstract class UserLoginTrackEditPanelBase extends QPanel {
	...
	public $lblId;
	public $txtUserId;
	public $chkLoginPassed;
	public $calAttempted;
	public $txtIp;
	public $txtUserNameAttempt;
	...
	protected function SetupUserLoginTrack($objUserLoginTrack) {
		if ($objUserLoginTrack) {
			$this->objUserLoginTrack = $objUserLoginTrack;
	...
	public function __construct($objParentObject, $strClosePanelMethod, $objUserLoginTrack = null, $strControlId = null) {
		// Call the Parent
		try {
		...
		$this->SetupUserLoginTrack($objUserLoginTrack);
