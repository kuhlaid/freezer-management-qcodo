 ...
 * must create a new Panel which extends this TypeOfRackEditPanelBase
 * class.
 *
 ...
 *
 */
abstract class TypeOfRackEditPanelBase extends QPanel {
	...
	protected function SetupTypeOfRack($objTypeOfRack) {
		if ($objTypeOfRack) {
			$this->objTypeOfRack = $objTypeOfRack;
	...
	public function __construct($objParentObject, $strClosePanelMethod, $objTypeOfRack = null, $strControlId = null) {
		// Call the Parent
		try {
		...
		$this->SetupTypeOfRack($objTypeOfRack);
