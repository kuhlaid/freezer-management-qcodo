 ...
 * must create a new Panel which extends this SampleRackEditPanelBase
 * class.
 *
 ...
 *
 */
abstract class SampleRackEditPanelBase extends QPanel {
	...
	protected function SetupSampleRack($objSampleRack) {
		if ($objSampleRack) {
			$this->objSampleRack = $objSampleRack;
	...
	public function __construct($objParentObject, $strClosePanelMethod, $objSampleRack = null, $strControlId = null) {
		// Call the Parent
		try {
		...
		$this->SetupSampleRack($objSampleRack);
